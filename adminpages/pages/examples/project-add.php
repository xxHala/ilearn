...
if ($cost ==0 ) $cost ='free';
        ...
        if (getimagesize($_FILES['photoFile']['tmp_name']) != false)
          ...
          $q= "INSERT INTO `course` (`id`, `s_id`, `title`, `cost`, `rate`, `photo`, `show_`, `teacher_id`, `desc`, `time`, `max_length`, `end_time`) VALUES (NULL, '$subject', '$title', '$cost', '0' ,'$photo', '1', '$teacher', '$des', '$time', '$maxSize', '$date');";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <section class="content  m-2">
      <div class="row">
        ...
        <div class="form-group">
                <label for="inputProjectLeader">رقم المدرس</label> <input required type="text" name="teacher" id="inputProjectLeader" class="form-control">
              </div>
        ...
        <div class="col-md-6">
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputEstimatedDate">تاريخ نهاية الدورة</label> <input required type="date" name="date" id="inputEstimatedDate" class="form-control">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
