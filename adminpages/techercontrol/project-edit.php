...
if ($cost ==0 ) $cost ='free';
    ...
    if ($_FILES['Photo']['tmp_name'])
        if (getimagesize($_FILES['Photo']['tmp_name']) != false)
          ...
          $q = "UPDATE `course` SET `s_id`= $subject ,`title`='$title',`photo`= '$photo',`cost`= '$cost' ,`desc`= '$des' ,`time`= $time ,`max_length`= $maxSize ,`end_time`= '$date' WHERE  `id`=".$course["id"]." AND`s_id`=".$course["SubjectId"].";";
         ...
         if ($result = $conn -> query($q)){
                  ...
                  echo "<br /><div class='alert alert-danger' role='alert'>خطأ : لم يتم تعدبل الدورة حاول مجددا</div>".$q."<br />";
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="techercontrol.html" class="nav-link">الصفحه الرئيسيه</a>
      </li>
...
<!-- Main content -->
                        ...
                        ?>
                              ...
                              <div class="form-group">
                                <label for="inputProjectLeader">المدرس</label>
                                 <?php
                                echo
                                '     <input disabled type="text" name="Teacher" id="inputProjectLeader" class="form-control" value="'.$course["teacherId"].' ">
                                ';
                                ?>
                              </div>
                        </div>   <!-- /.card-body -->
 ...
 <div class="row">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="#">mohand</a>.</strong> All rights reserved.
  </footer>
